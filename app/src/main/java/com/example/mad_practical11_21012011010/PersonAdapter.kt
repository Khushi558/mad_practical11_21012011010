package com.example.mad_practical11_21012011010
...
// Initialize the databaseHelper here
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            PersonViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.person_item_view,
                parent, false)
    ...
    override fun onBindViewHolder(holder: PersonViewHolder, position: Int) {
        ...
        holder.deleteBtn.setOnClickListener {
            ...
            if(count > 0)
            {
                Toast.makeText(this.context, " ${person.Name}'s details
